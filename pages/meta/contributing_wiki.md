...
{% include note.html content="If this doesn't work (for example a 404 error-page appears), check if in the settings of your repository (https://github.com/\<YOUR-USER-NAME\>/lineage_wiki/settings) under the heading 'GitHub Pages' a source ('master branch') is selected." %}
